...
//��������ʱ��ȫѡ
function ckplids(){
    var aplid = document.getElementById("aplids");
    if(aplid.checked){
        var dids = document.getElementsByName("plids");
        for(var i=0;i<dids.length;i++){
            dids[i].checked="checked";
        }
    }
    if(!aplid.checked){
        var dids = document.getElementsByName("plids");
...
//��������ʱ����Ƿ�ѡ��һ����ѡ��
function countplids(){
    var oplids = document.getElementsByName("plids");
    if(oplids.length==0){
        alert("��ѡ��Ҫɾ���ļ�¼��");
        return false;
    }
    for(var i=0;i<oplids.length;i++){
        if(oplids[i].checked){
            return true;
        }
    }
...
function uploadimg()
{ 
pop("/itivtmgr/js/uploadimg.jsp","�ϴ�ͼƬ",300,77)
}

function uploadimg2()
{
pop("/itivtmgr/js/uploadimg2.jsp","�ϴ�ͼƬ",300,77)
}

function uploadimg3()
{
pop("/itivtmgr/js/uploadimg3.jsp","�ϴ�ͼƬ",300,77)
}

function uploadimg4()
{
pop("/itivtmgr/js/uploadimg4.jsp","�ϴ�ͼƬ",300,77)
}


function uploadimg5()
{
pop("/itivtmgr/js/uploadimg5.jsp","�ϴ�ͼƬ",300,77)
}


function uploaddoc()
{
pop("/itivtmgr/js/uploaddoc.jsp","�ϴ��ĵ�",300,77)
}

function uploaddoc2()
{
pop("/itivtmgr/js/uploaddoc2.jsp","�ϴ��ĵ�",300,77)
}

function uploaddoc3()
{
pop("/itivtmgr/js/uploaddoc3.jsp","�ϴ��ĵ�",300,77)
}


function uploaddocfsh()
{
pop("/itivtmgr/js/uploaddocfsh.jsp","�ϴ��ĵ�",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="�ر�" src=/itivtmgr/js/dialogclose.gif  />';
   ...
   if(this.config.isSupportDraging){dropClass=new Dragdrop(this.config.width,this.config.height,this.info.shadowWidth,this.config.isSupportDraging,this.config.contentType);G("dialogBoxTitle").style.cursor="move"};this.lastBuild()},lastBuild:function(){var confirm='<div style="width:100%;height:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;border:0px">'+this.info.confirmCon+'</div><div style="margin:20px;"><input id="dialogOk" type="button" value=" ȷ�� "/>&nbsp;<input id="dialogCancel" type="button" value=" ȡ�� "/></div></div>';
   var alert='<div style="width:100%;height:100%;text-align:center;border:0px"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">'+this.info.alertCon+'</div><div style="margin:20px;"><input id="dialogYES" type="button" value=" ȷ�� "/></div></div>';
   ...
   oDialog['style']['top']=popheight+"px"     //����λ��
   },
