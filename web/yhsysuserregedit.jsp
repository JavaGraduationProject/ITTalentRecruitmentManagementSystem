        ...
        <div class=" " align="center">
            <div class="col-xl-5 col-md-4 col-12" >
                <div class="section-title">
                    <h2 class="title" style="font-size: 38px;padding: 10px;letter-spacing: 3px">用户注册</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<tr>
                                                                <td align="center" width="25%" height="46"></td>
                                                                <td align="center" width="15%" height="46"><center>姓名 : </center></td>
...
<tr>
                                                                <td align="center" width="25%" height="46"></td>
                                                                <td align="center" width="15%" height="46"><center>联系QQ : </center></td>
                                                                <td align="left"> <input type=text  onblur='checkform()' class='' id='qq' name='qq' size=35 /><label style='display:inline' id='clabelqq' />  </td>
                                                            </tr>
<tr>
                                                                <td align="center" width="25%" height="46"></td>
...
<tr>
                                                                ...
                                                                <td align="left"> <input type=text  onblur='checkform()' class='' id='passques' name='passques' size=60 /><label style='display:inline' id='clabelpassques' />  </td>
                                                            </tr>
<tr>
                                                                <td align="center" width="25%" height="46"></td>
                                                                <td align="center" width="15%" height="46"><center>密保答案 : </center></td>
                                                                <td align="left"> <input type=text  onblur='checkform()' class='' id='passans' name='passans' size=60 /><label style='display:inline' id='clabelpassans' />  </td>
                                                            </tr>
<tr>
                                                                <td align="center" width="25%" height="46"></td>
