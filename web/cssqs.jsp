        ...
        <div class=" " align="center">
            <div class="col-xl-5 col-md-4 col-12" >
                <div class="section-title">
                    <h2 class="title" style="font-size: 38px;padding: 10px;letter-spacing: 3px">测试申请</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<form name="f1" autocomplete="off" action="/itivtmgr/recruiting/cssqs.do" method="post" style="display: inline">
	 &nbsp;&nbsp;&nbsp;
企业名称 
&nbsp;:&nbsp; 
...
<div class="col mb-7"  >
	<div class=" blog-card-list2">
		<div class="thumb  p-0 text-center" style="height: 32px;margin-top: 10px" >
			<a href="/itivtmgr/recruiting/tocssqx.do?id=${sdata.id}">
				<h3 class="title" style="font-weight: 300;font-size: 18px">
					<font color="#9A9FA3">[ ${sdata.btype} ] </font>  
					<font color="black">${sdata.rtitle}</font>
					 &nbsp;&nbsp;&nbsp;&nbsp;
					<font color="#9A9FA3"> ${sdata.savetime} </font>  
				</h3>
			</a>
		</div>
