...
<!-- <form name="f1" autocomplete="off"  action="/itivtmgr/itivtmgr?ac=rcxxx&id=${id}"  method="post" style="display: inline"></form>-->
...
<table><tr><td height="15"></td></tr></table>
 ...
 <table><tr><td height="15"></td></tr></table>
     ...
     <span class="">    &nbsp; <c:if test="${ucollectNum==0}"> 
		          <a href="/itivtmgr/ucollect/ucollectopr.do?surl=torcxxx&id=${id}&table=sysuser&title=${updateentity.tname}">[收藏本页]</a> &nbsp;&nbsp;
		          </c:if> 
  &nbsp;  </span>
  ...
  <tr>
   ...
   <tr>
    <td height="30" class=" " valign="top"> 
       健康状况：${updateentity.health} 
     </td>
  </tr>

   <tr>
    <td height="30" class=" " valign="top"> 
       毕业院校：${updateentity.school} 
     </td>
  </tr>

   <tr>
    <td height="30" class=" " valign="top"> 
       专业领域：${updateentity.specialty}
     </td>
  </tr>
  ...
  <tr>
    ...
    <tr>
        <td height="30" class=" " valign="top">学历： ${updateentity.education} </td>
    </tr>
    <tr>
        <td height="30" class=" " valign="top">毕业日期： ${updateentity.cbdate} </td>
    </tr>
    <tr>
        <td height="30" class=" " valign="top">个人技能： ${updateentity.skill} </td>
    </tr>
    <tr>
        <td height="30" class=" " valign="top">兴趣爱好： ${updateentity.hobby} </td>
    </tr>
    <tr>
        <td height="30" class=" " valign="top">工作经历： ${updateentity.experience} </td>
    </tr>
    <tr>
        <td height="30" class=" " valign="top">外语技能： ${updateentity.languages} </td>
    </tr>
    <tr>
        <td height="30" class=" " valign="top">求职意向： ${updateentity.intention} </td>
    </tr>
    <tr>
        <td height="30" style="padding-top: 10px;padding-bottom: 10px" class=" " valign="top">简介： ${updateentity.remo} </td>
    </tr>
    <tr>
        <td height="30" class=" " valign="top">注册时间： ${updateentity.savetime} </td>
    </tr>
    <tr>
        <td height="30" class=" "  style="padding-top: 10px;padding-bottom: 10px" valign="top">图片： <img src='/itivtmgr/upfile/${updateentity.filename}' height='80' style="border-radius: 0px;height: 120px" /> </td>
    </tr>
    <tr>
        <td height="30" class=" " style="padding-top: 10px;padding-bottom: 10px"  valign="top">相关证书： <img src='/itivtmgr/upfile/${updateentity.filename2}' height='80' style="border-radius: 0px;height: 120px" /> </td>
    </tr>
    <tr>
        <td height="30" class=" " style="padding-top: 10px;padding-bottom: 10px"  valign="top">电子档简历： <a href='/itivtmgr/itivtmgr/download.do?filename=${updateentity.docname3}'>${updateentity.docname3}</a> </td>
    </tr>
