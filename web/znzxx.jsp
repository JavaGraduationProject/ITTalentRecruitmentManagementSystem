...
<!-- <form name="f1" autocomplete="off"  action="/itivtmgr/itivtmgr?ac=znzxx&id=${id}"  method="post" style="display: inline"></form>-->
...
<table width="100%" height="84" border="0" cellpadding="0" cellspacing="0">
                   ...
                   <center>
                    <font style="font-size: 35px"> ${updateentity.ntitle} </font>
...
<table><tr><td height="15"></td></tr></table>
 ...
 <table><tr><td height="15"></td></tr></table>
     ...
     <span class="">  ${updateentity.savetime} &nbsp;&nbsp;&nbsp; ${updateentity.btype} </span>
...
<jsp:param name="ftitle" value="${updateentity.ntitle}" />
<jsp:param name="ftable" value="zresources" />
