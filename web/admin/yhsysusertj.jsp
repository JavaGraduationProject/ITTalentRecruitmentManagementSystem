...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=yhsysusertj&tglparentid=${tglparentid}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()" action="/itivtmgr/sysuser/yhsysusertj.do?tglparentid=${tglparentid}" > 
<!-- servletformend --> 
