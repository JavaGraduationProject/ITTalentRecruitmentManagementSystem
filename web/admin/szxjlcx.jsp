...
<table width="100%" border="0" align="center" cellpadding="0" style="overflow-x:hidden;" cellspacing="0">
  ...
  <tr>
    <td>
     ...
     <div style="height:280px ;overflow:auto;overflow-x:hidden;" align="left" >
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="mytab"  style="overflow-x:hidden;"  onmouseover="changeto()"  onmouseout="changeback()">
      <div style="height: 10px"></div>
      <span id="mychat" style="font-size: 13px;margin-top: 5px">
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        &nbsp;&nbsp;发言&nbsp;:&nbsp;<input type="text" size="75" name='tcontent' id="tcontent" />&nbsp;&nbsp;
...
pop('zxjltj.jsp','信息添加',550,'100%')
      ...
      {
        var ajax = new AJAX();
        ajax.post("/itivtmgr/ajax/getsonops.do?ctype=tchat&id=${id}&touname=${touname}&tname=${uname}&tcontent="+document.getElementById("tcontent").value);
      ...
      var tk = "";
        var ajax = new AJAX();
        ajax.post("/itivtmgr/ajax/getsonops.do?ctype=chat&id=${id}&tname=${uname}");
