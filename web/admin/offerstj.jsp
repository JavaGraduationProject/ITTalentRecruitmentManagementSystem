...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=offerstj&tglparentid=${tglparentid}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()" action="/itivtmgr/offers/offerstj.do?tglparentid=${tglparentid}" > 
<!-- servletformend --> 
