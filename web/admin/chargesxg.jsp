...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=chargesxg&id=${id}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form  name="f1" method="post"  onsubmit="return checkform()" action="/itivtmgr/charges/chargesxg.do?id=${id}" > 
<!-- servletformend --> 
...
<td> <span id="stypedanx"><label  style='display:inline' ><input type=radio name='stype' value='面试咨询' />&nbsp;&nbsp;面试咨询 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio name='stype' value='简历升级' />&nbsp;&nbsp;简历升级 </label>&nbsp;&nbsp;
</span> </td> 
</tr>
<tr>
<th width='17%' align="center"><center>支付方式</center></td> 
<td> <span id="atypedanx"><label  style='display:inline' ><input type=radio name='atype' value='支付宝' />&nbsp;&nbsp;支付宝 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio name='atype' value='微信' />&nbsp;&nbsp;微信 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio name='atype' value='银行卡' />&nbsp;&nbsp;银行卡 </label>&nbsp;&nbsp;
</span> </td> 
</tr>
<tr>
...
<td> <input type=text size='8' class='' id='amt'  name='amt' onkeyup='clearNoNum(this);' onblur='clearNoNum(this);checkform();' onmouseup='clearNoNum(this);'  /><label id='clabelamt' /> </td> 
</tr>
<tr>
<th width='17%' align="center"><center>简述</center></td> 
<td> <textarea  cols='65' rows='5'  onblur='checkform()'   style='margin-top: 1px;margin-bottom: 1px'  class=''   name='remo'   ></textarea> </td> 
</tr>
