...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=recruitingtj&tglparentid=${tglparentid}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()" action="/itivtmgr/recruiting/recruitingtj.do?tglparentid=${tglparentid}" > 
<!-- servletformend --> 
...
<td> <span id="infotypedanx"><label  style='display:inline' ><input type=radio checked=checked name='infotype' id='infotype0' value='社招' />&nbsp;社招 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio  name='infotype' id='infotype1' value='校招' />&nbsp;校招 </label>&nbsp;&nbsp;
</span> </td> 
</tr>
<tr>
...
<td> <textarea  cols='45' rows='3'  style='margin-top: 1px;margin-bottom: 1px'  class=''  name='skills'  ></textarea> </td> 
</tr>
<tr>
