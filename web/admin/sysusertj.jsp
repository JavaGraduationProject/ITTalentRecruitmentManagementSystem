...
<!-- servletformstart -->
<form  action="/itivtmgr/itivtmgr?ac=sysusertj&tglparentid=<%=tglparentid%>"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
<!-- servletformend -->
<!-- s2formstart
sactionurl 
s2formend --> 
