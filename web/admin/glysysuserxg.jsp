...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=glysysuserxg&id=${id}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form  name="f1" method="post"  onsubmit="return checkform()" action="/itivtmgr/sysuser/glysysuserxg.do?id=${id}" > 
<!-- servletformend --> 
...
&nbsp;&nbsp;&nbsp;&nbsp;                     
<input type=button value=' 返回上页 ' onclick='window.location.replace("/itivtmgr/sysuser/glysysusercx.do")' />   
 </td> 
</tr>
