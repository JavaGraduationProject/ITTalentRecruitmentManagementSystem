...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=gmixinfoxg&id=${id}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form  name="f1" method="post"  onsubmit="return checkform()" action="/itivtmgr/mixinfo/gmixinfoxg.do?id=${id}" > 
<!-- servletformend --> 
...
<td> <input type=text  onblur='checkform()'  class='' id='mtitle' name='mtitle' size=60 /><label  style='display:inline'  id='clabelmtitle' /> </td> 
</tr>
<tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;                     
<input type=button value=' 返回上页 ' onclick='window.location.replace("/itivtmgr/mixinfo/gmixinfocx.do")' />   
 </td> 
</tr>
