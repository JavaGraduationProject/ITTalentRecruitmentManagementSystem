...
<form name="f1" autocomplete="off"  action="/itivtmgr/ucollect/zwucollectcx.do"  method="post" style="display: inline;font-size: 14px">
<div class="ms-panel">
...
<input type='checkbox' value='${sdata.id}' name='plids' />
					...
					<td scope="col">
<!----><a href="/itivtmgr/recruiting/tozpxxx.do?id=${sdata.pid}">查看</a>
 | 
<a onclick="return confirm('确定要删除这条记录吗?')" href="/itivtmgr/ucollect/delete.do?plids=${sdata.id}&surl=zwucollectcx">删除</a>
</td>
</tr>
</c:forEach> 
				<tr> 
...
if(countplids()) { 
f1.action='/itivtmgr/ucollect/customUpdate.do?surl=zwucollectcx&col='+col+''; 
...
if(confirm('是否确认删除？')){ 
if(countplids()) { 
f1.action='/itivtmgr/ucollect/delete.do?surl=zwucollectcx'; 
f1.submit(); 
}
}
}
