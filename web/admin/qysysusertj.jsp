...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=qysysusertj&tglparentid=${tglparentid}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()" action="/itivtmgr/sysuser/qysysusertj.do?tglparentid=${tglparentid}" > 
<!-- servletformend --> 
...
<td> <input type=text  onblur='checkform()'  size='12' class=''   name='founddate'  id='founddate' onclick='WdatePicker();'  /><label id='clabelfounddate' /> </td> 
</tr>
<tr>
<th width='17%' align="center"><center>企业类型</center></td> 
<td> <span id="companytypedanx"><label  style='display:inline' ><input type=radio checked=checked name='companytype' id='companytype0' value='民企' />&nbsp;民企 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio  name='companytype' id='companytype1' value='国企' />&nbsp;国企 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio  name='companytype' id='companytype2' value='事业' />&nbsp;事业 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio  name='companytype' id='companytype3' value='外资' />&nbsp;外资 </label>&nbsp;&nbsp;
<label  style='display:inline' ><input type=radio  name='companytype' id='companytype4' value='合资' />&nbsp;合资 </label>&nbsp;&nbsp;
</span> </td> 
</tr>
<tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;                     
<input type=button value=' 返回上页 ' onclick='window.location.replace("/itivtmgr/sysuser/qysysusercx.do")' />   
 </td> 
</tr>
