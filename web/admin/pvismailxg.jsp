...
<!-- servletformstart 
<form  action="/itivtmgr/itivtmgr?ac=pvismailxg&id=${id}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
 servletformend -->
<!-- s2formstart -->
<form  name="f1" method="post"  onsubmit="return checkform()" action="/itivtmgr/smail/pvismailxg.do?id=${id}" > 
<!-- servletformend --> 
...
<tr>
<th width='17%' align="center"><center>发送人</center></td> 
