        ...
        <div class=" " align="center">
            <div class="col-xl-5 col-md-4 col-12" >
                <div class="section-title">
                    <h2 class="title" style="font-size: 38px;padding: 10px;letter-spacing: 3px">TT</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<form name="f1" autocomplete="off" action="/itivtmgr/recruiting/tts.do" method="post" style="display: inline">
	 &nbsp;&nbsp;&nbsp;
企业名称 
&nbsp;:&nbsp; 
