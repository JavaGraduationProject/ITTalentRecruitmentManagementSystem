...
<!-- <form name="f1" autocomplete="off"  action="/itivtmgr/itivtmgr?ac=zpxxx&id=${id}"  method="post" style="display: inline"></form>-->
...
<table width="100%" height="84" border="0" cellpadding="0" cellspacing="0">
     ...
     <span class="">    &nbsp; <c:if test="${ucollectNum==0}">
		          <a href="/itivtmgr/ucollect/ucollectopr.do?surl=tozpxxx&id=${id}&table=recruiting&title=${updateentity.rtitle}">[收藏本页]</a> &nbsp;&nbsp;
		          </c:if>
  &nbsp;  </span>
  ...
  <tr>
    <td height="30" class=" " valign="top" align="center">
...
<input type=hidden name='url' value='/recruiting/tozpxxx.do' />
...
<c:if test="${admin.utype=='会员'}" >
&nbsp;&nbsp;&nbsp;
申请信息 ：<input type='text' size='95' name='applyremo' id='applyremo' />
