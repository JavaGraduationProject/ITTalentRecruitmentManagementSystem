        ...
        <div class=" " align="center">
            <div class="col-xl-5 col-md-4 col-12" >
                <div class="section-title">
                    <h2 class="title" style="font-size: 38px;padding: 10px;letter-spacing: 3px">企业注册</h2>
                </div>
            </div>
        </div>
        <div class="row">
                                        ...
                                        <div class=" ">
                                            <div class="thumb  p-0 text-center" style="height: 42px;margin-top: 10px;display: inline" >
                                                ...
                                                <h3  style="font-weight: 500">
                                                    ...
                                                    <!-- single blog start -->
                                                    <!-- servletformstart 
                                                    <form  action="/itivtmgr/itivtmgr?ac=qysysuserregedit&tglparentid=${tglparentid}"   autocomplete="off"  style="display: inline;font-size: 15px" name="f1" method="post"  onsubmit="return checkform()" >
                                                         servletformend -->
                                                        <!-- s2formstart -->
                                                        <form name="f1" method="post" onsubmit="return checkform()" action="/itivtmgr/sysuser/qysysuserregedit.do?tglparentid=${tglparentid}" > 
                                                        <!-- servletformend -->
