...
<!-- <form name="f1" autocomplete="off"  action="/itivtmgr/itivtmgr?ac=cssqx&id=${id}"  method="post" style="display: inline"></form>-->
...
<input type=hidden name='fshstatus' value='申请中-已同意' /> 
<input type=hidden name='url' value='/recruiting/tocssqx.do' /> 
