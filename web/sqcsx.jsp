...
<!-- <form name="f1" autocomplete="off"  action="/itivtmgr/itivtmgr?ac=sqcsx&id=${id}"  method="post" style="display: inline"></form>-->
...
<input type=hidden name='fshstatus' value='申请中-同意' /> 
<input type=hidden name='url' value='/recruiting/tosqcsx.do' /> 
