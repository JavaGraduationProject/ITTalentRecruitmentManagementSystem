...
public interface SmailMapper {
   ...
   // 查询功能 : 发送邮件  
   List<HashMap<String, String>> smailcx(HashMap<String, String> map);

   // 查询功能 : 接收邮件  
   List<HashMap<String, String>> fshsmailcx(HashMap<String, String> map);
