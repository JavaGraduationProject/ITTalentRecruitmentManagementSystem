...
public class ViewhistoryServiceImpl implements ViewhistoryService {
	...
	@Resource
	public  ViewhistoryMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, ViewhistoryMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Viewhistory".equals("Sysuser"))
