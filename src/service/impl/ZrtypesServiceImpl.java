...
@Service("ZrtypesService")
public class ZrtypesServiceImpl implements ZrtypesService {
	 
	@Resource
	public  ZrtypesMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, ZrtypesMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Zrtypes".equals("Sysuser"))
