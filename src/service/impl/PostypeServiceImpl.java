...
public class PostypeServiceImpl implements PostypeService {
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, PostypeMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Postype".equals("Sysuser"))
