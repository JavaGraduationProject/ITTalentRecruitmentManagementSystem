...
public class ChargesServiceImpl implements ChargesService {
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, ChargesMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Charges".equals("Sysuser"))
	...
	public void insert(HashMap<String, String> map)
	{
        if(map.get("uname")!=null&&!map.get("uname").equals("")){
 		...
 		String unamekey = new CommDAO().getID("charges","uname","sysuser","uname",uname);
 		map.put("sysuserkey",unamekey);
 		}
        mapper.insert(map);
	}
