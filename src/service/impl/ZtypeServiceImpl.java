...
public class ZtypeServiceImpl implements ZtypeService {
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, ZtypeMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Ztype".equals("Sysuser"))
