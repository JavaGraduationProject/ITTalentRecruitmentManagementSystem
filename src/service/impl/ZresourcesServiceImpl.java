...
@Service("ZresourcesService")
public class ZresourcesServiceImpl implements ZresourcesService {
	 
	@Resource
	public  ZresourcesMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, ZresourcesMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Zresources".equals("Sysuser"))
