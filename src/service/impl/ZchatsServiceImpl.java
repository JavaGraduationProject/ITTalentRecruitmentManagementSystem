...
@Service("ZchatsService")
public class ZchatsServiceImpl implements ZchatsService {
	 
	@Resource
	public  ZchatsMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, ZchatsMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Zchats".equals("Sysuser"))
