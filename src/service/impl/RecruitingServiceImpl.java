...
public class RecruitingServiceImpl implements RecruitingService {
	...
	@Resource
	public  RecruitingMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, RecruitingMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Recruiting".equals("Sysuser"))
