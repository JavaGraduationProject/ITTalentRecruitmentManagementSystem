...
public class UcollectServiceImpl implements UcollectService {
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, UcollectMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Ucollect".equals("Sysuser"))
