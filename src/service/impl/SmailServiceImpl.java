...
@Service("SmailService")
public class SmailServiceImpl implements SmailService {
	 
	@Resource
	public  SmailMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, SmailMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Smail".equals("Sysuser"))
