...
public class OffersServiceImpl implements OffersService {
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, OffersMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Offers".equals("Sysuser"))
