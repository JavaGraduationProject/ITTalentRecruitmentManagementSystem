...
@Service("ExamdtlService")
public class ExamdtlServiceImpl implements ExamdtlService {
	 
	@Resource
	public  ExamdtlMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, ExamdtlMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Examdtl".equals("Sysuser"))
	...
	{
		mapper.update(map);
		new CommDAO().updateById("exams","examdtl","examdtl","~hnoname","","0" );
