...
@Service("RepbussService")
public class RepbussServiceImpl implements RepbussService {
	 
	@Resource
	public  RepbussMapper mapper;
	...
	{
		List<HashMap> list = PageManager.getPages(pageUrl,pageSize, RepbussMapper.class.getName()+"."+selectMethod,selectmap, request ); 
		if(!"Repbuss".equals("Sysuser"))
